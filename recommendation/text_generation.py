...
class TextGen:
    ...
    def generate_descriptions_for_clusters(self):
        for clust, (
                ...
                max_dur_per_case,
                avg_dur_per_case, events_per_case) in self.clus_to_prop.items():
    ...
    def generate_description_for_cluster(self, clust, event_types, resources, roles, cat_atts, num_atts, preceded_by,
        ...
        self.generate_event_stats_text(clust, events_per_case)
    ...
    def generate_event_stats_text(self, clust, events_per_case):
